...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'ApexDivision_CustomerAddressAttribute' => 1,
        'ApexDivision_CustomerAttribute' => 1,
        'ApexDivision_ProductAttribute' => 1,
        'ApexDivision_ProductDeliveryEstimate' => 0,
        'ApexDivision_ProductPageBrandName' => 1,
        'ApexDivision_SMS' => 1,
        ...
        'Ves_Brand' => 0,
        'Ves_Setup' => 0,
        'Webkul_AddProductlogo' => 1,
        'Webkul_Grid' => 1,
        'Alakmalak_MarketplaceExtended' => 1,
        'Webkul_MpAssignProduct' => 1,
        'Webkul_MpHyperLocal' => 1,
        'WeltPixel_Backend' => 1,
