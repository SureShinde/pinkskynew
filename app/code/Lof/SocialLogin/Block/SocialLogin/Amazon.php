...
class Amazon extends SocialLogin
{
    ...
    /**
     * @return \Lof\SocialLogin\Helper\Amazon\Data
     */
    protected function helperAmazon()
    {
        return $this->objectManager->create('Lof\SocialLogin\Helper\Amazon\Data');
    }
     ...
     */
    protected function amazonModel()
    {
        return $this->objectManager->create('Lof\SocialLogin\Model\Amazon');
    }
    ...
    {
        return $this->amazonModel()->getAmazonLoginUrl();
    }
}
