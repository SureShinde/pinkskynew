...
class Facebook extends SocialLogin
{
    ...
    /**
     * @return Lof\SocialLogin\Helper\Facebook\Data
     */
    protected function helperFacebook()
    {
        return $this->objectManager->create('Lof\SocialLogin\Helper\Facebook\Data');
    }
    ...
    {
        return $this->objectManager->create('Lof\SocialLogin\Model\FacebookApp');
    }
