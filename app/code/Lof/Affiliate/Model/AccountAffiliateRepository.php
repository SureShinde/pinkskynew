...
class AccountAffiliateRepository implements AccountRepositoryInterface
{
    ...
    {
        if (!$this->helper->getConfig('general_settings/enable')) return false;
    ...
    public function createTransaction($data)
    {
        ...
        foreach ($this->_collection as $order) {
            ...
            if($email != $data['customer_email'] || $customer_id != $data['customer_id']) return false;
            ...
            if ($orderStatus == $complete_order_status) return false;
            ...
            if (!empty($ordersData)) return false;
