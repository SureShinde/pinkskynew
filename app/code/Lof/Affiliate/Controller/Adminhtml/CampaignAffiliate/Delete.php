...
class Delete extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Lof_Affiliate::campaign_delete');
    }
    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__('The Campaign Affiliate has been deleted.'));
                // go to grid
        ...
        // display error message
        $this->messageManager->addError(__('We can\'t find a campaign affiliate to delete.'));
        // go to grid
        return $resultRedirect->setPath('*/*/');
    }
}
