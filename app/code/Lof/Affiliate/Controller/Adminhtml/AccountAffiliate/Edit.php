...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Lof_Affiliate::account_edit');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Lof_Affiliate::account_settings')
            ->addBreadcrumb(__('Affiliate Account'), __('Affiliate Account'))
            ->addBreadcrumb(__('Manage Affiiate Account'), __('Manage Affiiate Account'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(
            $id ? __('Edit Affiliate Account') : __('New Affiliate Account'),
            $id ? __('Edit Affiliate Account') : __('New Affiliate Account')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Affiliate'));
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? ($model->getFirstname()." ".$model->getLastname()) : __('New Affiliate Account'));
