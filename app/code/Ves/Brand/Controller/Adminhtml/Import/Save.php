                   ...
                   foreach($importData as $item_data) {
                        ...
                        if($product_sku) {
                           ...
                           if($brand_index !== false) {
                                ...
                                $brand_values[] = $brand_value; // added by Nir
                            ...
                            if($brand_values && $product_id) {
                                ...
                                // disabled by nir $brand_model->deleteBrandsByProduct($product_id);
                                foreach($brand_values as $brand_value){
                                    ...
                                    if($brand_value){
                                        ...
                                        $brand_model->deleteBrandsByProduct($product_id); // added by nir
