...
class Save extends \Magento\Framework\App\Action\Action
{
     ...
     public function execute()
     {
          ...
          if ($this->getRequest()->isPost()) {
               ...
               $targetDir = $this->_filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath('productlogo/');
               ...
               if(!empty($_FILES["logo_four"]["name"])){
                    ...
                    $post->addData($arr);
                    $saveData = $post->save(); 
                    $this->messageManager->addSuccess(__('Product Logo has been successfully Added.'));
