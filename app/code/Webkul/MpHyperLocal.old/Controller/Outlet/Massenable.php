...
class Massenable extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
{
    const STATUS = 1;
    ...
    public function execute()
    {
        ...
        if ($isPartner == 1) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__("A total of %1 outlet(s) were enabled.", $collection->getSize()));
            } catch (\Exception $e) {
