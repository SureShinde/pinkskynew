<?php
namespace Alakmalak\MarketplaceExtended\Block\Adminhtml\Customer\Edit;
...
class Tabs extends \Webkul\Marketplace\Block\Adminhtml\Customer\Edit\Tabs
{
    public function initForm()
    {
        ...
        if ($partner['whatsapp_active'] == 1) {
            $whatappActive = "value='1' checked='checked'";
        }
        ...
        $fieldset->addField(
            ...
            [
                ...
                'value' => $partner['whatsapp_id'],
                'after_element_html' => '<input
                    type="checkbox"
                    name="whatsapp_active"
                    data-form-part="customer_form"
                    onchange="this.value = this.checked ? 1 : 0;"
                    title="'.__('Allow to Display Whatapp Icon in Profile Page').'"
                    '.$whatappActive.'
                >',
            ]
        );
        $fieldset->addField(
            ...
            [
                ...
                'value' => $partner['whatsapp_message'],
            ]
        );
        $fieldset->addField(
            'contact_number',
